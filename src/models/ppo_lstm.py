...
class PPOLSTMAgent:
    """
    Production-quality PPO agent with LSTM.
    Correctly handles temporal dependencies and trains efficiently.
    """
    ...
    def __init__(self, env, device: str = 'cpu', lr: float = 3e-4, 
        ...
        Args:
            ...
            ppo_minibatch_size: Number of sequences per minibatch
    ...
    def collect_rollout(self, num_steps: int, render: bool = False) -> Dict:
        ...
        for step in range(num_steps):
            ...
            # Store transition with BOTH input and output hidden states
            # Also store next_obs for accurate GAE bootstrapping
            self.storage.add(obs, action, log_prob, value, reward, done, 
